...
async function getData2() {
  const response = await fetch(
    "https://raw.githubusercontent.com/SmartPracticeschool/SBSPS-Challenge-2671-Sentiment-analysis-of-COVID-19-tweets-Visualization-dashboard/master/data/news.csv"
  );
...
function getNews() {
  document.getElementById(
    "news1"
  ).innerHTML = `<a href="${links[0]}" target="_blank">
<img src="${imgs[0]}" width="300" height="300"><br>
</a>
<h3>${titls[0]}</h3>`;

  document.getElementById(
    "news2"
  ).innerHTML = `<a href="${links[1]}" target="_blank">
<img src="${imgs[1]}" width="300" height="300"><br>
</a>
<h3>${titls[1]}</h3>`;

  document.getElementById(
    "news3"
  ).innerHTML = `<a href="${links[2]}" target="_blank">
<img src="${imgs[2]}" width="300" height="300"><br>
</a>
<h3>${titls[2]}</h3>`;
}
